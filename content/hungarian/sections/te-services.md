...
description: "Kötésminta-tervezőknek jelenleg az alábbi szolgáltatásokat nyújtom"

services:
    - process_step: "Kötésminták lektorálása"
      ...
      content: |
        ...
        *További részletekért lásd **A folyamat**ot lentebb.*
    ...
    - process_step: "A minta- és vázlatrajzok ára"
      icon: "images/transfer.png"
      content: |
...
button:
  enable: true
  content: "Vágjunk bele?"
  label: "Kérj ingyenes árajánlatot!"
