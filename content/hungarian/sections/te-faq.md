...
enable: true
title: "GYIK"
description: "Ha kérdésed támadna, itt kezdd"

button:
  enable: true
  content: "Ha még mindig bizonytalan vagy, nyugodtan tedd fel a kérdéseidet."
  label: "Kérdésem van"
...
{{< accordion title="Milyen fájlformátumokat fogadsz el?" class="border-indigo-900 border-1 bg-slate-50" >}}
...
{{< accordion title="Hogyan számolod ki egy kötésminta szószámát?" class="border-indigo-900 border-1 bg-slate-50" >}}
